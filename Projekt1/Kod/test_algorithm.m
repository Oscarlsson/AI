function [ error, timing ] = test_algorithm( algorithm_handle, training_dataset, training_dataset_labels, test_dataset, test_dataset_labels, training_dataset_size_fraction )
...
for i = 1:1 %10:CVP.NumTestSets
    ...
    classifications = feval(algorithm_handle, training_data(1:training_data_size), ...
        training_targets(1:training_data_size), test_data);
