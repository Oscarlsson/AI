...
% The K-Nearest Neighbour (KNN) algorithm is one of the simplest machine learning algorithms. 
...
%First of all, how is distance defined? There is of course a natural
