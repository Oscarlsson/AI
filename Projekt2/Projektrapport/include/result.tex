...
\begin{itemize}
\item if $any$, the planner could treat the possible blocks as different parse trees and choose the one that gives the simpliest solution.  
\item if $the$, and there is more than one possible block that was referred, the system should let the user specify which one was meant or choose the one that gives the simpliest solution. 
